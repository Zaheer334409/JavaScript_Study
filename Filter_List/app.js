// _____________________-Filter_Task
...
//             if (listingText[i].innerHTML.toLowerCase().indexOf(filterText.value.toLowerCase()) !== -1) {
...
// function filterList() {
//     let listingText = listing.childNodes; // ____li,#text
//     for (let i = 0; i < listingText.length; i++) {
//         if (listingText[i].nodeType === 1) {
//             if (listingText[i].innerHTML.toLowerCase().indexOf(filterText.value.toLowerCase()) !== -1) {
//                 listingText[i].style.display = "Block"
